...
class IndexView(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.headers.get('HX-Request'):
            return TemplateResponse(request, 'main/category.html', context)
...
class CatalogView(TemplateView):
    ...
    FILTER_MAPPING = {
        'manufacturer' : lambda queryset, value: queryset.filter(manufacturer__icontains=value),
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            ...
            'manufacturers': Product.objects.all(),
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.headers.get('HX-Request'):
            ...
            template = 'main/filter_modal.html' if request.GET.get('filter_modal') == 'true' else 'main/catalog.html'
